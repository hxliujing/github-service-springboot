...
public class SpringMybatisConfig {
    ...
    public static MapperScannerConfigurer lifeCircleConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.javens.springboot.dubbo.provider.db");
    ...
    public DruidDataSource lifeCircleDataSource() throws SQLException {
        ...
        druidDataSource.setUrl(sysConfig.getLifeCircleJdbcUrl());
        druidDataSource.setUsername(sysConfig.getLifeCircleJdbcUsername());
        druidDataSource.setPassword(sysConfig.getLifeCircleJdbcPassword());
    ...
    public SqlSessionFactoryBean sqlSessionFactory() throws IOException, SQLException {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:/com/javens/springboot/dubbo/provider/db/mapper/*.xml"));
